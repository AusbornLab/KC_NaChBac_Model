...
#define initmodel initmodel__na_bac_strege
#define _net_receive _net_receive__na_bac_strege
#define _net_init _net_init__na_bac_strege
#define nrn_state_launcher nrn_state_na_bac_strege_launcher
#define nrn_cur_launcher nrn_cur_na_bac_strege_launcher
#define nrn_jacob_launcher nrn_jacob_na_bac_strege_launcher 
#define states states_na_bac_strege 
...
#define t _nt->_t
#define dt _nt->_dt
#define gmax _p[0*_STRIDE]
#define ina _p[1*_STRIDE]
#define ina2 _p[2*_STRIDE]
...
#define _slist1 _slist1_na_bac_strege
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_na_bac_strege
int* _dlist1;
