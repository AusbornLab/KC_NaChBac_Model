...
#define dt _nt->_dt
#define napgmax _p[0]
#define napgmax_columnindex 0
#define ina _p[1]
#define ina_columnindex 1
#define ina2nap _p[2]
#define ina2nap_columnindex 2
#define m _p[3]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nap /mnt/c/Users/antho/OneDrive - Drexel University/Documents/KC_Github/nap.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
    Dm = ( 1.0 / ( 1.0 + exp ( 0.2717 * ( - 48.77 - v ) ) ) - m ) / taum ( _threadargscomma_ v ) ;
    }
 return _reset;
}
 ...
 static int states (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) { {
     m = m + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / taum ( _threadargscomma_ v ))))*(- ( ( ( ( 1.0 ) / ( 1.0 + exp ( 0.2717 * ( - 48.77 - v ) ) ) ) ) / taum ( _threadargscomma_ v ) ) / ( ( ( ( - 1.0 ) ) ) / taum ( _threadargscomma_ v ) ) - m) ;
    }
  return 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/c/Users/antho/OneDrive - Drexel University/Documents/KC_Github/nap.mod";
static const char* nmodl_file_text = 
